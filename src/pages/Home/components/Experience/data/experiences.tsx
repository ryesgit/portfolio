...
const experiences: experience[] = [
	{
		...
		endDate: "Present",
		description: [
			"Working closely with two senior developers and two co-interns to develop frontend and backend services for a livestock leasing platform.",
			"Using Nest.js for the backend; helped building a GraphQL API",
			"Learning the CQRS design pattern, best practices for writing clean code; bolstered understanding of the SOLID principles",
		],
	},
	{
