...
const BlogPostEditor = ({ post, onSave, onCancel }: BlogPostEditorProps) => {
  ...
  const predefinedCategories = ["tech", "science", "life", "meta"];
      ...
      <form id="post-form" onSubmit={handleSubmit} className="editor-form">
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            {validation.excerpt && (
              <span className="validation-error">{validation.excerpt}</span>
            )}
          </div>
        </div>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            {validation.category && (
              <span className="validation-error">{validation.category}</span>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            />
            {validation.tags && (
              <span className="validation-error">{validation.tags}</span>
            )}
          </div>
        </div>
        ...
        <div className="form-row">
          <div className="form-group">
            ...
            />
            {validation.slug && (
              <span className="validation-error">{validation.slug}</span>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            />
            {validation.readTime && (
              <span className="validation-error">{validation.readTime}</span>
            )}
          </div>
          ...
          <div className="form-group">
            ...
            {validation.publishDate && (
              <span className="validation-error">{validation.publishDate}</span>
            )}
          </div>
        </div>
      </form>
